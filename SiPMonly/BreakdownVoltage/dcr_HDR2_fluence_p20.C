...
int dcr_HDR2_fluence_p20() {
  ...
  //===
  iFile[ 0] = "20200915_HDR2-1/p20C/dark/HDR2-0e0-1-20C-dark-1.csv";
  iFile[ 1] = "20200915_HDR2-1/p20C/dark/HDR2-0e0-1-20C-dark-2.csv";
  iFile[ 2] = "20200916_HDR2-2/p20C/dark/HDR2-0e0-2-20C-dark-1.csv";
  iFile[ 3] = "20200916_HDR2-2/p20C/dark/HDR2-0e0-2-20C-dark-2.csv";
  iFile[ 4] = "20200826_HDR2-1e13/p22C/dark/HDR2-1e13-21.5C-dark-1.csv";
  iFile[ 5] = "20200826_HDR2-1e13/p22C/dark/HDR2-1e13-21.5C-dark-2.csv";
  iFile[ 6] = "20200915_HDR2-1e13-2/p20C/dark/HDR2-1e13-2-20C-dark-1.csv";
  iFile[ 7] = "20200915_HDR2-1e13-2/p20C/dark/HDR2-1e13-2-20C-dark-2.csv";
  iFile[ 8] = "20200826_HDR2-5e13/p18C/dark/HDR2-5e13-18C-dark-1.csv";
  iFile[ 9] = "20200826_HDR2-5e13/p18C/dark/HDR2-5e13-18C-dark-2.csv";
  iFile[10] = "20200831_HDR2-5e13-2/p20C/dark/HDR2-5e13-2-20C-dark-1.csv";
  iFile[11] = "20200831_HDR2-5e13-2/p20C/dark/HDR2-5e13-2-20C-dark-2.csv";
  //iFile[12] = "20200826_HDR2-2e14/p20C/dark/HDR2-2e14-20C-dark-1.csv";
  //iFile[13] = "20200826_HDR2-2e14/p20C/dark/HDR2-2e14-20C-dark-2.csv";
  iFile[14] = "20200831_HDR2-2e14-2/p20C/dark/HDR2-2e14-2-20C-dark-1.csv";
  iFile[15] = "20200831_HDR2-2e14-2/p20C/dark/HDR2-2e14-2-20C-dark-2.csv";
  //===
  tFile[ 0] = "20200915_HDR2-1/p20C/dark/HDR2-0e0-1-20C-dark-temps-1.csv";
  tFile[ 1] = "20200915_HDR2-1/p20C/dark/HDR2-0e0-1-20C-dark-temps-2.csv";
  tFile[ 2] = "20200916_HDR2-2/p20C/dark/HDR2-0e0-2-20C-dark-temps-1.csv";
  tFile[ 3] = "20200916_HDR2-2/p20C/dark/HDR2-0e0-2-20C-dark-temps-1.csv";
  tFile[ 4] = "20200826_HDR2-1e13/p22C/dark/HDR2-1e13-21.5C-dark-temps-1.csv";
  tFile[ 5] = "20200826_HDR2-1e13/p22C/dark/HDR2-1e13-21.5C-dark-temps-2.csv";
  tFile[ 6] = "20200915_HDR2-1e13-2/p20C/dark/HDR2-1e13-2-20C-dark-temps-1.csv";
  tFile[ 7] = "20200915_HDR2-1e13-2/p20C/dark/HDR2-1e13-2-20C-dark-temps-2.csv";
  tFile[ 8] = "20200826_HDR2-5e13/p18C/dark/HDR2-5e13-18C-dark-temps-1.csv";
  tFile[ 9] = "20200826_HDR2-5e13/p18C/dark/HDR2-5e13-18C-dark-temps-2.csv";
  tFile[10] = "20200831_HDR2-5e13-2/p20C/dark/HDR2-5e13-2-20C-dark-temps-1.csv";
  tFile[11] = "20200831_HDR2-5e13-2/p20C/dark/HDR2-5e13-2-20C-dark-temps-2.csv";  
  //tFile[12] = "20200826_HDR2-2e14/p20C/dark/HDR2-2e14-20C-dark-temps-1.csv";
  //tFile[13] = "20200826_HDR2-2e14/p20C/dark/HDR2-2e14-20C-dark-temps-2.csv";
  tFile[14] = "20200831_HDR2-2e14-2/p20C/dark/HDR2-2e14-2-20C-dark-temps-1.csv";
  tFile[15] = "20200831_HDR2-2e14-2/p20C/dark/HDR2-2e14-2-20C-dark-temps-2.csv";
  ...
  main2->SetGridx(1);
  main2->SetGridy(1);
  TH2D *axis2 = new TH2D("axis2",";Overvoltage  (V);Dark Count Rate  (I^{sub}/e/gain/enf*1e-9)    (GHz)",100,0,5,100,1e-7,1e3);
  axis2->Draw();
  for(int i=0; i!=NFILES; ++i)
    if(i!=12&&i!=13)
      grDCR[i]->Draw("SAMEP");
  ...
  TString legs[16] = {
    ...
    "5e13","5e13","5e13","5e13",
    "2e13","2e14","2e14","2e14" };
  TLegend *leg = new TLegend(0.53,0.63,0.88,0.87,"HDR2      @ +20 C");
  for(int i=0; i!=NFILES; ++i) {
    if(i!=12&&i!=13)
  ...
  TH2D *axis3 = new TH2D("axis3",";#Phi;Dark Count Rate   (GHz)",100,0,2.1e14,100,1e-6,250);
  ...
  //TF1 *fitT = new TF1("fitT","[0]+[1]*x+[2]*x*x");
  //TF1 *fitT = new TF1("fitT","[0]*pow(x,[1])");
  //grT[0]->Fit(fitT);
  //grT[0]->Fit(fitT);
  
  TLegend *legT = new TLegend(0.14,0.69,0.54,0.87,"HDR2      @ +20C");
