...
#root  bvfinder.C\(\"20200811_n30C/HDR2-_Chdirect_iLED-1-20200811-1303.csv\",0.07,36.8,42.0\); #looking good
...
# -30 DEG (somewhere between)
root -l -q overvoltage.C\(\"20200826_HDR2-2e14/n30C/dark/HDR2-2e14-n30C-dark-1.csv\",\"20200831_HDR2-2e14-2/temperatureTrend.txt\",\"20200826_HDR2-2e14/n30C/dark/HDR2-2e14-n30C-dark-temps-1.csv\"\);
