...
int temperatureTrendHDR5e13_2() {
  ...
  //photon
  int nP=0;
  readtemperature("20200831_HDR2-5e13-2/n30C/light/HDR2-5e13-2-n30C-light-temps-1.csv",xP[nP],exP[nP]);
  readfile("20200831_HDR2-5e13-2/n30C/light/HDR2-5e13-2-n30C-8.2mA-Orange-1.csv_HDR2-5e13-2-n30C-dark-1.csv_IVCURVE.csv", yLandauMeanP[nP], yLandauStdP[nP], tmp, tmp, yLinearMeanP[nP], yLinearStdP[nP]);
  nP++;
  readtemperature("20200831_HDR2-5e13-2/n30C/light/HDR2-5e13-2-n30C-light-temps-2.csv",xP[nP],exP[nP]);
  readfile("20200831_HDR2-5e13-2/n30C/light/HDR2-5e13-2-n30C-8.2mA-Orange-2.csv_HDR2-5e13-2-n30C-dark-1.csv_IVCURVE.csv", yLandauMeanP[nP], yLandauStdP[nP], tmp, tmp, yLinearMeanP[nP], yLinearStdP[nP]);
  nP++;
  //
  readtemperature("20200831_HDR2-5e13-2/n20C/light/HDR2-5e13-2-n20C-light-temps-1.csv",xP[nP],exP[nP]);
  readfile("20200831_HDR2-5e13-2/n20C/light/HDR2-5e13-2-n20C-8.85mA-Orange-1.csv_HDR2-5e13-2-n20C-dark-1.csv_IVCURVE.csv", yLandauMeanP[nP], yLandauStdP[nP], tmp, tmp, yLinearMeanP[nP], yLinearStdP[nP]);
  nP++;
  readtemperature("20200831_HDR2-5e13-2/n20C/light/HDR2-5e13-2-n20C-light-temps-2.csv",xP[nP],exP[nP]);
  readfile("20200831_HDR2-5e13-2/n20C/light/HDR2-5e13-2-n20C-8.85mA-Orange-2.csv_HDR2-5e13-2-n20C-dark-1.csv_IVCURVE.csv", yLandauMeanP[nP], yLandauStdP[nP], tmp, tmp, yLinearMeanP[nP], yLinearStdP[nP]);
  nP++;
  //
  readtemperature("20200831_HDR2-5e13-2/n10C/light/HDR2-5e13-2-n10C-light-temps-1.csv",xP[nP],exP[nP]);
  readfile("20200831_HDR2-5e13-2/n10C/light/HDR2-5e13-2-n10C-9.47mA-Orange-1.csv_HDR2-5e13-2-n10C-dark-1.csv_IVCURVE.csv", yLandauMeanP[nP], yLandauStdP[nP], tmp, tmp, yLinearMeanP[nP], yLinearStdP[nP]);
  nP++;
  readtemperature("20200831_HDR2-5e13-2/n10C/light/HDR2-5e13-2-n10C-light-temps-2.csv",xP[nP],exP[nP]);
  readfile("20200831_HDR2-5e13-2/n10C/light/HDR2-5e13-2-n10C-9.47mA-Orange-2.csv_HDR2-5e13-2-n10C-dark-1.csv_IVCURVE.csv", yLandauMeanP[nP], yLandauStdP[nP], tmp, tmp, yLinearMeanP[nP], yLinearStdP[nP]);
  nP++;
  //
  readtemperature("20200831_HDR2-5e13-2/zeroC/light/HDR2-5e13-2-0C-light-temps-1.csv",xP[nP],exP[nP]);
  readfile("20200831_HDR2-5e13-2/zeroC/light/HDR2-5e13-2-0C-10.2mA-Orange-1.csv_HDR2-5e13-2-0C-dark-1.csv_IVCURVE.csv", yLandauMeanP[nP], yLandauStdP[nP], tmp, tmp, yLinearMeanP[nP], yLinearStdP[nP]);
  nP++;
  readtemperature("20200831_HDR2-5e13-2/zeroC/light/HDR2-5e13-2-0C-light-temps-2.csv",xP[nP],exP[nP]);
  readfile("20200831_HDR2-5e13-2/zeroC/light/HDR2-5e13-2-0C-10.2mA-Orange-2.csv_HDR2-5e13-2-0C-dark-1.csv_IVCURVE.csv", yLandauMeanP[nP], yLandauStdP[nP], tmp, tmp, yLinearMeanP[nP], yLinearStdP[nP]);
  nP++;
  //
  readtemperature("20200831_HDR2-5e13-2/p10C/light/HDR2-5e13-2-10C-light-temps-1.csv",xP[nP],exP[nP]);
  readfile("20200831_HDR2-5e13-2/p10C/light/HDR2-5e13-2-10C-10.5mA-Orange-1.csv_HDR2-5e13-2-10C-dark-1.csv_IVCURVE.csv", yLandauMeanP[nP], yLandauStdP[nP], tmp, tmp, yLinearMeanP[nP], yLinearStdP[nP]);
  nP++;
  readtemperature("20200831_HDR2-5e13-2/p10C/light/HDR2-5e13-2-10C-light-temps-2.csv",xP[nP],exP[nP]);
  readfile("20200831_HDR2-5e13-2/p10C/light/HDR2-5e13-2-10C-10.5mA-Orange-2.csv_HDR2-5e13-2-10C-dark-1.csv_IVCURVE.csv", yLandauMeanP[nP], yLandauStdP[nP], tmp, tmp, yLinearMeanP[nP], yLinearStdP[nP]);
  nP++;
  //
  readtemperature("20200831_HDR2-5e13-2/p20C/light/HDR2-5e13-2-20C-light-temps-1.csv",xP[nP],exP[nP]);
  readfile("20200831_HDR2-5e13-2/p20C/light/HDR2-5e13-2-20C-10.6mA-Orange-1.csv_HDR2-5e13-2-20C-dark-1.csv_IVCURVE.csv", yLandauMeanP[nP], yLandauStdP[nP], tmp, tmp, yLinearMeanP[nP], yLinearStdP[nP]);
  nP++;
  readtemperature("20200831_HDR2-5e13-2/p20C/light/HDR2-5e13-2-20C-light-temps-2.csv",xP[nP],exP[nP]);
  readfile("20200831_HDR2-5e13-2/p20C/light/HDR2-5e13-2-20C-10.6mA-Orange-2.csv_HDR2-5e13-2-20C-dark-1.csv_IVCURVE.csv", yLandauMeanP[nP], yLandauStdP[nP], tmp, tmp, yLinearMeanP[nP], yLinearStdP[nP]);
  nP++;
  //
